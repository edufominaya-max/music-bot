...
“cover_prompt”: “prompt para imagen: carátula de disco profesional, sin texto, estilo artístico coherente con el género”,
...
print(”   Generando carátula con FLUX.1…”)
return hf_request(
HF_IMAGE_API,
{“inputs”: f”{prompt}, album cover art, professional music artwork, high quality, square format, no text, no letters”},
output_path
)
...
folder = f”output/{date_str}*{style[‘genre’].replace(’ ’, ’*’)}”
