...
COVER_STYLES = {
    ...
    "george_michael": "glossy 1980s pop photography, neon lights, urban night scene, stylish and cinematic, no text",
    ...
    "luis_miguel":    "elegant soft focus portrait style, warm romantic lighting, sophisticated and timeless, no text",
    "julio_iglesias": "classic vinyl album photography aesthetic, warm Mediterranean light, elegant and timeless, no text",
}
...
def generate_album_track(subgenre, artist_key, style, track_num, total_tracks, all_used_titles, is_single=False):
    ...
    if is_single:
        single_note = (
            ...
            "instantly memorable track. Explosive hook, unforgettable chorus. "
        )
...
def generate_cover(prompt, style_type, output_path):
    print("Generando caratula con Pollinations...")
    ...
    for i in range(5):
        try:
            ...
            if response.status_code == 200:
                ...
                print("Pollinations error " + str(response.status_code) + " reintentando...")
                time.sleep(10)
        except Exception as e:
            print("Error caratula: " + str(e) + " reintentando...")
            time.sleep(10)
